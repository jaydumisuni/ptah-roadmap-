...
Begin **A07 — Object, Revision, Artifact, Location and local CAS** from P0C-I007 and frozen WP03, WP07 and WP10 contracts.

A07 depends on accepted A03 durability, A04 Activity/Operation/Attempt/Receipt provenance and A06 persistent Workspace authority. Inspect existing public implementation in `jaydumisuni/Ptah-space` before adding code.

Do not widen A07 into A08 transfer execution, P01P Prime-native integration, production or release claims.
