...
patches = (
    ...
    (
        ...
        '''replace_once("tools/test_check_archive_af02.py", '    MISSION,\\n    RESULT_JSON,\\n    RESULT_MD,\\n    ValidationError,', '    MISSION,\\n    RESULT_JSON,\\n    RESULT_MD,\\n    ACCEPTANCE,\\n    ValidationError,')''',
    ),
    (
...
replace_once("tools/test_check_archive_formation.py", '\"accepted_archive_record_count\": 9', '\"accepted_archive_record_count\": 19')
